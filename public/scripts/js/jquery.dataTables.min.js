...
sEmptyTable:"Nenhum item encontrado",sInfo:"Mostrando de _START_ at&eacute; _END_ de _TOTAL_ itens",sInfoEmpty:"Nenhum item encontrado",sInfoFiltered:"(total de _MAX_)",sInfoPostFix:"",sSearch:"Pesquisa:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",bRegex:false,bSmart:true};this.aoPreSearchCols=
